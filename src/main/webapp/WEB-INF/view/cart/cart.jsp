...
<body>
	...
	<section class="cart">
        <div class="container">
            <h3>장바구니</h3>
            <form action="order" method="post" name="cartForm">
                <div>
               		...
               		%>
                        ...
                        <script type="text/javascript">
							function shipsel<%=i%>() {
								...
								window.open("shipsel?f_id="+id.value+"&num="+<%=i%>, "searchPop", "status=no, width="+popupwidth+", height="+popupheight+",left="+popx+",top="+popy);
							}
						</script>
                    </tr>
                    <% 
