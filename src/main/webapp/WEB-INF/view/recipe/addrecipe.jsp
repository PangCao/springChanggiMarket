...
<body>
    ...
    <section class="recipe_add">
        <div class="container">
            ...
            <form action="addrecipeprocess" class="row" method="post" enctype="multipart/form-data" name="addrecipeForm">
                <div class="col-6">
...
<script type="text/javascript">
	...
	function food_search() {
		...
		window.open("foodsearch?search="+document.getElementById('foodsearch').value ,"searchPop","status=no, width="+popupwidth+", height="+popupheight+",left="+popx+",top="+popy);
	}
