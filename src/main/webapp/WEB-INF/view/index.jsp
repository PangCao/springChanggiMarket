...
<link rel="stylesheet" href="<c:url value="/resources/css/style.css?ver=1.4"/>">
    ...
    <section class="main">
            ...
            <div>
                ...
                <div>
                    <div>
                        ...
                        <a href="<c:url value='/recipe/recipes?r_category=밥·죽&page=1'/>" class="btn btn-primary">Recipe</a>
                    </div>
                    <div>
                ...
                <div>
                    <div>
                        ...
                        <a href="<c:url value='/community/review?page=1'/>" class="btn btn-primary">나만의 레시피</a>
                    </div>
                    <div>
                ...
                <div>
                    <div>
                        ...
                        <a href="<c:url value='/community/faq?page=1'/>" class="btn btn-primary">자주하는 질문</a>
                    </div>
                    <div>
        ...
        <div class="container">
            ...
            <div>
                ...
                <div class="col-4 t">
                    <div>
                        <a href="recipe/recipe?id=<%=rl.getR_id()%>"><img src="resources/images/<%=rl.getR_img() %>" alt=""></a>
                    </div>
                    <div>
                        <div>
                        </div>
                    </div>
                    <a class="col-12" href="recipe/recipe?id=<%=rl.getR_id()%>">
	                    <div class="col-12">
	                        <h4><%=rl.getR_name() %></h4>
	                        <p><%=rl.getR_desc() %></p>
	                    </div>
