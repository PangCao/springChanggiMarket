        ...
        <div class="container">
        	<div class="row">
            	<div class="col-3">
                    ...
                    <ul>
                        <a href="<c:url value='/login/store_management?order=waiting&page=1'/>"><li>주문 내역<span>&gt;</span></li></a>
                        <a href="<c:url value='/login/modisellerchk'/>"><li>점포 정보 수정<span>&gt;</span></li></a>
                    </ul>
                </div>
                <div class="col-9">
                    <form action="selmodi" method="post" name="selmodiForm">
   	                    <div class="row col-12 d-flex align-items-center justify-content-center form-group">
	                        <label class="col-3">사업자등록번호</label>
	                        <input type="text" class="col-7 form-control" readonly name="s_com_number" value="<%=sellinfo.getS_com_number()%>">
	                    </div>
                        <div class="mt-5 row col-12 d-flex align-items-center justify-content-center form-group">
                            <label class="col-3">아이디</label>
                            <input type="text" class="col-7 form-control" readonly name="s_id" value="<%=name%>">
                        </div>
                        <div class="row col-12 d-flex align-items-center justify-content-center form-group">
                        ...
                        <div class="row col-12 d-flex align-items-center justify-content-center form-group">
	                        ...
	                        <input type="text" class="col-7 form-control" id="com_name" name="s_com_name" value="<%=sellinfo.getS_com_name()%>">
	                    </div>
	                    <div class="row col-12 d-flex align-items-center justify-content-center form-group">
	                        <label class="col-3">대표자 이름</label>
	                        <input type="text" class="col-7 form-control" id="owner_name" name="s_owner_name" value="<%=sellinfo.getS_owner_name()%>">
	                    </div>
	                    <div class="row col-12 d-flex align-items-center justify-content-center form-group">
	                        <label class="col-3">이메일</label>
	                        <input type="text" class="col-7 form-control" id="email" name="s_mail" value="<%=sellinfo.getS_mail()%>">
	                    </div>
	                    <div class="row col-12 d-flex align-items-center justify-content-center form-group">
	                        <label class="col-3">휴대전화</label>
	                        <input type="text" class="col-7 form-control" id="phone" name="s_phone" value="<%=sellinfo.getS_phone()%>">
	                    </div>
	                    <div class="row col-12 d-flex align-items-center justify-content-center form-group">
	                        <label class="col-3">주소</label>
	                        <input type="text" class="col-7 form-control" readonly name="s_addr" value="<%=sellinfo.getS_addr()%>">
	                    </div>
	                    <%
