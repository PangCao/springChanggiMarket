...
<body>
    ...
    <section class="seller_signup">
        <div class="container">
            ...
            <hr>
            <div>
                <form action="seller_signupprocess" method="post" name="signForm" class="form-horizatal col-9">
                    <div class="form-group row">
                        <label class="col-3">아이디 <span>*</span></label>
                        <input name="s_id" id="id" type="text" placeholder="아이디(8자리 이상)" required class="form-control col-5 id">
                    ...
                    <div class="form-group row">
                        ...
                        <input name="s_com_name" id="name" type="text" placeholder="기업명을 입력해주세요." required class="form-control col-5">
                    </div>
                    <div class="form-group row">
                        <label class="col-3">사업자등록번호 <span>*</span></label>
                        <input name="s_com_number" id="number" type="text" placeholder="'-'포함하여 입력해주세요." required class="form-control col-5">
                    ...
                    <div class="form-group row">
                    	...
                    	<div class="col-5">
                    		...
                    		<p id="sellnumnull" style="display: none; color : red;">사업자등록번호를 입력해주세요.</p>
                    		<input type="hidden" id="sellnumchkbul" value="">
                    	</div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3">대표자명 <span>*</span></label>
                        <input name="s_owner_name" id="ownername" type="text" placeholder="대표자명을 입력해주세요." required class="form-control col-5">
                    </div>
                    <div class="form-group row">
                        <label class="col-3">이메일 <span>*</span></label>
                        <input name="s_mail" id="mail" type="text" placeholder="이메일 (920907v@naver.com)" required class="form-control col-5">
                    ...
                    <div class="form-group row">
                        ...
                        <input name="s_phone" id="phone" type="text" placeholder="'-'을 포함하여 입력해주세요." required class="form-control col-5">
                    </div>
                    <div class="form-group row">
