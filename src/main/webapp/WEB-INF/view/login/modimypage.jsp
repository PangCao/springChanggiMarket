...
ArrayList<CartlistDto> mycart = (ArrayList<CartlistDto>)session.getAttribute("myCart");
	CustomerDto ct = (CustomerDto)request.getAttribute("userinfo");
          ...
          <div class="container">
               <div class="row">
                    <div class="col-3">
                         ...
                         <ul>
                              <a href="mypage?page=1&orderperiod=1year"><li>주문 내역 <span>&gt;</span></li></a>
                              <a href="<c:url value='/community/one_qna?page=1'/>"><li>상품 문의<span>&gt;</span></li></a>
                              <a href="<c:url value='/login/modimypagechk'/>"><li>개인정보 수정<span>&gt;</span></li></a>
                         </ul>
                    </div>
                    <div class="col-9">
                         <form action="modi" method="post" name="modiForm">
	                         ...
	                         <div class="row col-12 d-flex align-items-center justify-content-center form-group">
	                              ...
	                              <input type="text" class="col-7 form-control" id="mail" name="mail" value="<%=ct.getMail()%>">
	                         </div>
	                         <div class="row col-12 d-flex align-items-center justify-content-center form-group">
...
<script type="text/javascript">
	...
	function modi() {
		...
		if (!check(/^[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}$/, mail, "[이메일]\n이메일 형식을 확인해주세요.")){
			return false;
		}
