...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-9">
                    ...
                    <hr>
                    <div>
                        <a href="<c:url value='/community/one_qna?page=1'/>" class="btn btn-secondary">1:1 문의하기</a>
                    </div>
                </div>
                <div class="col-12">
                <%
                ...
                %>
               	...
               	%>
                <a href="mypage?page=<%=cupage+1%>&orderperiod=<%=order_p%>" class="pagenum"><b>&gt;</b></a></p>
                <%
                	}
                %>
            	</div>
    ...
    <script type="text/javascript">
    	function orderperi() {
    		...
    		location.href="mypage?orderperiod="+ordervalue+"&page=1";
    	}
    </script>
</body>
</html>