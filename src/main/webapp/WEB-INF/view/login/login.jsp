	...
	<jsp:include page="../menu.jsp"/>
 	<section class="login">
        <div class="container">
            <div class="col-6">
                <h3>LOGIN</h3>
                <form action="loginlo" class="form-horizatal" method="post">
                    ...
                    <div class="form-group">
                        <a href="sel_login" class="form-control">회원가입</a>
                    </div>
                </form>
                <div>
                    <a href="javascript:openNewWindow('find_id')">이메일 아이디 찾기</a> | <a href="javascript:openNewWindow('find_pw')">패스워드 찾기</a>
                </div>
                <div>
                    <span>SNS 간편 로그인</span>
                </div>
                <div>
                    <a href="" class="form-control">네이버 아이디로 로그인<br>(미구현)</a>
                    <a href="" class="form-control">카카오 아이디로 로그인<br>(미구현)</a>
                </div>
            </div>
        </div>
    </section>
