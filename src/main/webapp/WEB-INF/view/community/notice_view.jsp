            ...
            <div>
            	<%
            		...
            		if (previous == -1) { }
            			...
            			if (category.equals("공지사항")){
                %>
                <a href="notice_view?id=<%=previous%>&page=<%=cupage%>&category=<%=category %>" class="btn btn-secondary col-2">이전글</a>
                <%
            			}
            			else if (category.equals("게시판")){
            	%>
            	<a href="bulletin_view?id=<%=previous%>&page=<%=cupage%>&category=<%=category %>" class="btn btn-secondary col-2">이전글</a>
            	<%
            			}
            			else if (category.equals("1:1 문의")){
            				
            	%>
            	<a href="one_view?id=<%=previous%>&page=<%=cupage%>&category=<%=category %>" class="btn btn-secondary col-2">이전글</a>
            	<%
            			}
            			else {
        		%>
        		...
        		<%
            		...
            		if (next == -1) {}
            			...
            			if (category.equals("공지사항")){
                %>
                <a href="notice_view?id=<%=next%>&page=<%=cupage%>&category=<%=category %>" class="btn btn-secondary col-2">다음글</a>
                <%
            			}
            			else if (category.equals("게시판")){
            	%>
            	<a href="bulletin_view?id=<%=next%>&page=<%=cupage%>&category=<%=category %>" class="btn btn-secondary col-2">다음글</a>
            	<%
            			}
            			else if (category.equals("1:1 문의")){
            				
            	%>
            	<a href="one_view?id=<%=next%>&page=<%=cupage%>&category=<%=category %>" class="btn btn-secondary col-2">다음글</a>
            	<%
            			}
            			else {
        		%>
   				<a href="review_view?id=<%=next%>&page=<%=cupage%>&category=<%=category %>" class="btn btn-secondary col-2">다음글</a>
        		<%
            			}
            		...
            		if(category.equals("공지사항")){
                %>
                <a href="notice?page=<%=cupage %>&category=<%=category %>" class="btn btn-success col-2">목록</a>
                <%
            		}
            		else if (category.equals("게시판")){
                %>
                <a href="bulletin?page=<%=cupage %>&category=<%=category %>" class="btn btn-success col-2">목록</a>
                <%
            		}
            		else if (category.equals("1:1 문의")){
                %>
                <a href="one_qna?page=<%=cupage %>&category=<%=category %>" class="btn btn-success col-2">목록</a>
                <%
            		}
            		else {
                %>
                <a href="review?page=<%=cupage %>&category=<%=category %>" class="btn btn-success col-2">목록</a>
                <%
            		}
