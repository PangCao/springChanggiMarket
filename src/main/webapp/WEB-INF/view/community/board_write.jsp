            ...
            <form action="" method="post" enctype="multipart/form-data" name="boardForm">
                ...
                <div>
                    ...
                    <%
                		if (category.equals("공지사항")) {
                    %>
                    	<a href="notice?page=1" class="btn btn-danger col-2">취소</a>
                    <%
                		}
                		else if (category.equals("1:1 문의")){
                    %>
                    	<a href="one_qna?page=1" class="btn btn-danger col-2">취소</a>
                    <%
                		}
                		else if (category.equals("게시판")){
                    %>
                    	<a href="bulletin?page=1" class="btn btn-danger col-2">취소</a>
                    <%
                		}
                		else if (category.equals("나만의 레시피")){
					%>
						<a href="review?page=1" class="btn btn-danger col-2">취소</a>
					<%
                		}
					%>
