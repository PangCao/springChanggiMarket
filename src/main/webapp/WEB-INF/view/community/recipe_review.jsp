...
<body>
	...
	<section class="re_review">
        ...
        <div class="container">
            ...
            <div>
	            <form action="review?page=<%=cupage%>" method="post" name="searchForm" class="col-4">
            ...
            %>
                <div class="col-3" id="p_move">
                    <div>
                        <a href="review_view?id=<%=bl.getId()%>&page=<%=cupage%>&category=나만의 레시피"><img src="../resources/images/<%=bl.getImg()[0] %>" alt="" class="col-12"></a>
                        <div>
                            <a href="review_like?id=<%=bl.getId()%>&page=<%=cupage%>"><i class="fa-solid fa-heart"></i><span> LIKE <%=bl.getLike() %></span></a>
                        </div>
                    </div>
                    <a href="review_view?id=<%=bl.getId()%>&page=<%=cupage%>&category=나만의 레시피">
                        <h5><%= bl.getTitle() %></h5>
            ...
            <div>
                <a href="board_write?category=나만의 레시피" class="btn btn-secondary col-2">글쓰기</a>
            </div>
            <div class="col-12">
                <%
	            		if (cupage == 1){
                ...
                <%
               	...
               	%>
                <a href="review?page=<%=cupage+1%>&search_title=<%=search_title%>" class="pagenum"><b>&gt;</b></a></p>
                <%
                		}
				%>
            </div>
